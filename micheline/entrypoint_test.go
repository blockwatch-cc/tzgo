...
var entryInfo = []entryTest{
	...
	entryTest{
		...
		Want: `{
			"balance_of":{"id":0,"call":"balance_of","branch":"/L/L/L","type":[{"name":"requests","type":"list","args":[{"name":"_item","type":"struct","args":[{"name":"owner","type":"address"},{"name":"token_id","type":"nat"}]}]},{"name":"callback","type":"contract","args":[{"name":"0","type":"list","args":[{"name":"_item","type":"struct","args":[{"name":"request","type":"struct","args":[{"name":"owner","type":"address"},{"name":"token_id","type":"nat"}]},{"name":"balance","type":"nat"}]}]}]}]},
			"hDAO_batch":{"id":1,"call":"hDAO_batch","branch":"/L/L/R","type":[{"name":"","type":"list","args":[{"name":"_item","type":"struct","args":[{"name":"amount","type":"nat"},{"name":"to_","type":"address"}]}]}]},
			"mint":{"id":2,"call":"mint","branch":"/L/R/L","type":[{"name":"address","type":"address"},{"name":"amount","type":"nat"},{"name":"token_id","type":"nat"},{"name":"token_info","type":"map","args":[{"name":"_key","type":"string"},{"name":"_value","type":"bytes"}]}]},
			...
			"token_metadata":{"id":5,"call":"token_metadata","branch":"/R/L/R","type":[{"name":"token_ids","type":"list","args":[{"name":"_item","type":"nat"}]},{"name":"handler","type":"lambda","args":[{"name":"_param","type":"list","args":[{"name":"_item","type":"struct","args":[{"name":"token_id","type":"nat"},{"name":"token_info","type":"map","args":[{"name":"_key","type":"string"},{"name":"_value","type":"bytes"}]}]}]},{"name":"_return","type":"unit"}]}]},
			"transfer":{"id":6,"call":"transfer","branch":"/R/R/L","type":[{"name":"","type":"list","args":[{"name":"_item","type":"struct","args":[{"name":"from_","type":"address"},{"name":"txs","type":"list","args":[{"name":"_item","type":"struct","args":[{"name":"to_","type":"address"},{"name":"token_id","type":"nat"},{"name":"amount","type":"nat"}]}]}]}]}]},
			"update_operators":{"id":7,"call":"update_operators","branch":"/R/R/R","type":[{"name":"","type":"list","args":[{"name":"_item","type":"union","args":[{"name":"add_operator","type":"struct","args":[{"name":"owner","type":"address"},{"name":"operator","type":"address"},{"name":"token_id","type":"nat"}]},{"name":"remove_operator","type":"struct","args":[{"name":"owner","type":"address"},{"name":"operator","type":"address"},{"name":"token_id","type":"nat"}]}]}]}]}
		}`,
	},
